module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c12 = function(r, l) { return [r].concat(l); },
        ...
        peg$c35 = function(macroname, argument) {
            return {
              type: 'macro',
        ...
        peg$c36 = function(macroname) {
            return {
              type: 'macro',
              content: '@' + macroname.join('')
            };
          },
        peg$c37 = function(m, rest) {
        ...
        peg$c50 = function(starttag, attrs, annotation) {
            return {
              name: starttag,
        ...
        peg$c53 = function(endtag) { return endtag },
        peg$c54 = "/>",
        peg$c55 = { type: "literal", value: "/>", description: "\"/>\"" },
        peg$c56 = function(tagname, attrs, annotation) {
            return {
              name: tagname,
              attributes: attrs === null ? {} : attrs,
              annotation: annotation
        ...
        peg$c58 = function(starttag, c, endtag) {
        ...
        peg$c60 = function(a, m) { parser_util.merge_attributes(m,a) },
        peg$c61 = function(a) { return parser_util.merge_attributes({}, a); },
        peg$c62 = "=\"",
        ...
        peg$c72 = function(invert, functionname) {
        ...
        peg$c73 = "@foreach",
        peg$c74 = { type: "literal", value: "@foreach", description: "\"@foreach\"" },
        peg$c75 = "in",
        peg$c76 = { type: "literal", value: "in", description: "\"in\"" },
        peg$c77 = function(func, collection) {
            return {
              type: 'iteration',
              funcall: func,
        ...
        peg$c79 = function(funcall) {
            return funcall;
          },
        peg$c80 = function(lit, lst) { return [lit].concat(lst); },
        peg$c81 = function(lit) { return [lit] },
        peg$c82 = /^[a-zA-Z0-9]/,
        peg$c83 = { type: "class", value: "[a-zA-Z0-9]", description: "[a-zA-Z0-9]" },
        peg$c84 = function(letters) { return letters.join(""); },
        peg$c85 = /^[ \n\t]/,
